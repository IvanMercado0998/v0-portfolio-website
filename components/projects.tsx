...
export default function Projects() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      tags: ["Qmetry", "Jira", "Quality Assurance", "Testing ", "IOB Devices"],
      skills: ["Device Testing", "Testing Protocols", "Hands-On",],
      media: [
        { type: "image", src: "/QA4.jpg", alt: "Testing with Qmetry @ Jira" },
        { type: "image", src: "/QA3.jpg", alt: "Testing with Qmetry @ Jira" },
        { type: "image", src: "/QA2.jpg", alt: "Testing with Qmetry @ Jira" },
        { type: "image", src: "/QA1.jpg", alt: "Testing with Qmetry @ Jira" },
        { type: "image", src: "/QA.jpg", alt: "Testing with Qmetry @ Jira" },
      ],
    },
        {
      id: 6,
      ...
      tags: ["IC Programming", "Drivers", "ADCs", "Schematics", "IOB Devices"],
      skills: ["Schematics", "IC Drivers", "Precision Readings","Code Architecture",],
      media: [
        { type: "image", src: "/Drivers.png", alt: "TMUX1309 Schematics" },
        { type: "image", src: "/Drivers1.png", alt: "ADC Code Architecture" },
      ],
    },
    {
      id: 7,
